...
namespace Pd.Api.BootstrapSupport
{
    public static class DefaultScaffoldingExtensions
    {
        ...
        public static object GetValue(this object model, string name)
        {
            return model.GetType().GetProperty(name).GetValue(model, new object[0]);
        }
